...
import { findService, type FindServiceOutput } from '@/ai/flows/find-service-flow';
...
export function ServicesToolbar({ categories, onFilterChange }: ServicesToolbarProps) {
  ...
  const handleAiSearch = async () => {
    ...
    try {
        ...
        const result: FindServiceOutput = await findService({ prompt: searchTerm, availableCategories });
